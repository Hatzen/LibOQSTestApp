...
public class Sigs {
     ...
     */
    private static de.hartz.software.parannoying.helper.security.liboqs.java.Sigs single_instance = null;
     ...
     */
    public static synchronized de.hartz.software.parannoying.helper.security.liboqs.java.Sigs get_instance() {
        if (single_instance == null) {
            single_instance = new de.hartz.software.parannoying.helper.security.liboqs.java.Sigs();
        }
